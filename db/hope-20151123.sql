...
) ENGINE=InnoDB AUTO_INCREMENT=23 DEFAULT CHARSET=utf8 COMMENT='审计日志表';
...
) ENGINE=InnoDB AUTO_INCREMENT=73 DEFAULT CHARSET=utf8 COMMENT='登录日志表';
...
INSERT INTO `menu` VALUES ('13', 'Hope.app.sys.logs', null, null, '审计日志', '5', 'COMPONENT', 'Log', 'export', '2', '1', '1');
INSERT INTO `menu` VALUES ('14', 'Hope.app.sys.loginlogs', null, null, '登录日志', '6', 'COMPONENT', 'LoginLog', 'export', '2', '1', '1');
INSERT INTO `menu` VALUES ('15', 'druid/index.html', null, null, 'Druid监控', '7', 'URL', null, 'create,update,delete', '2', '1', '1');
...
INSERT INTO `user` VALUES ('1', '2', 'admin', '90dc23253021c713053cb915765c3052bafa0891', '201f9dec2a970c12', '管理员', '1', 'boychen111@21cn.com', '', '123456789', '0', '2015-11-22 22:19:05', '127.0.0.1', null, '0000-00-00 00:00:00', '2015-04-03 10:41:57', '1');
