...
public interface ModuleMapper {
	 ...
	 * 根据条件查询记录集
	 */
	List<Module> selectMyModules(Criteria example);
	 ...
	 * 根据条件更新属性不为空的记录
	 */
	int updateByExampleSelective(@Param("record") Module record, @Param("condition") Map<String, Object> condition);

	/**
	 * 根据条件更新记录
	 */
	int updateByExample(@Param("record") Module record, @Param("condition") Map<String, Object> condition);
