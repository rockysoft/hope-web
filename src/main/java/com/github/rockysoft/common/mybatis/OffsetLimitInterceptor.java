package com.github.rockysoft.common.mybatis;
...
import com.github.rockysoft.common.mybatis.dialect.Dialect;
import com.github.rockysoft.common.utils.PropertiesHelper;
 ...
 * 		&lt;property name="dialectClass" value="com.chenxin.authority.common.mybatis.dialect.MySQLDialect"/>
 * 	&lt;/plugin>
 * &lt;/plugins>
 * </pre>
 * 
...
public class OffsetLimitInterceptor implements Interceptor {
	...
	private MappedStatement copyFromMappedStatement(MappedStatement ms, SqlSource newSqlSource) {
		...
		//builder.keyProperty(ms.getKeyProperty()); //mybatis 3.0.9写法,3.1替换以下写法
...
//        } 
     ...
     * @return 字符串 
     */ 
	static public String arrayToString(String[] aSource) { 
