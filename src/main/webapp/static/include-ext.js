...
(function() {
    ...
    if (includeCSS) {
        document.write('<link rel="stylesheet" type="text/css" href="' + '' + 'http://cdn.staticfile.org/extjs/4.2.1/resources/css/ext-all' + suffix + '-debug.css"/>');
    } 
    document.write('<script type="text/javascript" src="http://cdn.staticfile.org/extjs/4.2.1' + '' + '/ext-all' + (rtl ? '-rtl' : '') + '-debug.js"></script>');
    document.write('<script type="text/javascript" src="http://cdn.staticfile.org/extjs/4.2.1/locale/ext-lang-zh_CN.js"></script>');
    if (neptune) {
        ...
        neptunePath = //(repoDevMode ? path + '' : path) +
            'http://cdn.staticfile.org/extjs/4.2.1/ext-theme-neptune' +
            (repoDevMode ? '-dev' : '') + '.js';
