...
//alert("-1:"+value);alert("0:"+me.store.getNodeById(value));
        // try to find a record in the store that matches the value
        record = value ? me.store.getNodeById(value) : me.store.getRootNode();
        if (value === undefined) {
            record = me.store.getRootNode();
            me.value = record.getId();
        } else {//alert("1:"+me.store.getNodeById(value));
            record = me.store.getNodeById(value);//alert("2:"+record);
        }
//alert("3:"+record.get(me.displayField));
